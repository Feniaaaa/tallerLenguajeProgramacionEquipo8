...
public class SecurityConfig {
	  ...
	  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
	    ...
	    http.csrf().disable().authorizeRequests()
	        ...
	        .antMatchers(HttpMethod.GET		, "/lote/**").permitAll()
	        .antMatchers(HttpMethod.POST	, "/lote/**").permitAll()
	        .antMatchers(HttpMethod.PUT		, "/lote/**").permitAll()
	        .antMatchers(HttpMethod.DELETE	, "/lote/**").permitAll()
